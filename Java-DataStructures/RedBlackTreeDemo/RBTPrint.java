class RBTPrint {
   public static String treeToString(RBTNode subtreeRoot) {
      if (subtreeRoot == null) {
         return "(empty tree)";
      }
   ...
   private static String nodeToString(RBTNode node) {
      if (node.isRed()) {
         return "[" + node.key + " red]";
      }
   ...
   private static String[] treeToLines(RBTNode subtreeRoot) {
      if (subtreeRoot == null) {
         return new String[0];
      }
